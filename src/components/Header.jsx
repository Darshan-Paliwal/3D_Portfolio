...
function Header() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 w-full glass z-50 p-4 flex flex-col items-center" // Changed to flex-col to allow expansion
    >
      ...
      {isMenuOpen && (
        <motion.ul
          ...
          className="md:hidden menu-glass p-4 rounded-md absolute top-full left-4 right-4 w-auto z-60 bg-opacity-90" // Adjusted width to auto and full width
          style={{ background: 'rgba(255, 255, 255, 0.05)', minWidth: '180px' }} // Ensured minimum width
        >
          {['hero', 'about', 'projects', 'contact'].map((section) => (
